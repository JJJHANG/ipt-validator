...
$(document).ready(function () {
    ...
    $(".back-btn").click(function () {
        window.location.href = `/data-edit?project_name=${projectName}&project_id=${projectID}&edit=${isEdit}`;
    });

    $(".save-result-btn").click(function () {
        const exportUrl = `/data-validation/download_error_messages?project_id=${projectID}`;
